...
<div class="projectSection">
    ...
    <p>
        ...
        websites. Currently, I've just used it to generate my own CV in <Latex
        />->pdf. When I've made it a little more user-friendly, I'll make it
        public.
    </p>
    ...
    <ul>
        ...
        <li>
            Selectable/configurable levels of detail and visibility in the
            output for individual data items
        </li>
