...
mediaCaptionsByFilename:
    - [handlebroken1.jpg, Broken silk wrappings]
    - [handlebroken2.jpg, Broken silk wrappings]
    - [handlebroken3.jpg, Old wrappings mostly removed - paper triangles visible in background]
    - [handlefix1.jpg, Preparing the paper triangles]
    - [handlefix2.jpg, Preparing the paper triangles]
    - [handlefix3.jpg, Gluing the base paper with rice glue]
    - [handlefix4.jpg, Gluing the manta ray skin with rice glue]
    - [handlefix5.jpg, Drying]
    - [handlefix6.jpg, Wrapping the new silk - self made resin mix used as adhesive]
    - [handlefix7.jpg, Wrapping - my own variant of a jig for holding the handle]
    - [handlefix8.jpg, Nearly done!]
    - [handlefix9.jpg, Wrapping up the ends]
    - [handlefix10.jpg, Finished wrapping]
    - [handlefix11.jpg, Finished wrapping]
    - [handlerepaird.jpg, Fully repaired - handle cleaned and mounted]
...
<MDGallery entry={props.entry} sortBy="fileNameList"
    fileNames={["handlebroken1.jpg", "handlebroken2.jpg", "handlebroken3.jpg", "handlefix1.jpg",
...
<MDGallery entry={props.entry} sortBy="fileNameList"
    fileNames={["handlefix7.jpg", "handlefix8.jpg", "handlefix9.jpg", "handlefix10.jpg", "handlefix11.jpg"]} />
